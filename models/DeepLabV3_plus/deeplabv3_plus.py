...
if __name__ == '__main__':
    ...
    # deeplabv3_ = DeepLabv3_plus(in_channels=3, num_classes=1, backend='resnet101', os=16).cuda()
    # deeplabv3_.to(device)
    # summary(deeplabv3_, (3, 512, 512), batch_size=1)
    # print('Total params: ', sum(p.numel() for p in deeplabv3_.parameters() if p.requires_grad))
    # x = torch.randn(2, 3, 512, 512)
    # out = deeplabv3_(x.to(device))
